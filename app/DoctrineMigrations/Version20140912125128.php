...
class Version20140912125128 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE BudgetUser');
    }
}
